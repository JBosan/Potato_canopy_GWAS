...
write.csv(all_qtl, "GWAS_poly_output/K_method/k_method_all_qtl_bonferroni.csv")
```
...
write.csv(LD_qtl, "GWAS_poly_output/K_method/k_method_LD_qtl_bonferroni.csv")
```
...
write.csv(all_qtl, "GWAS_poly_output/K_method/k_method_all_qtl_m.eff.csv")
```
...
write.csv(LD_qtl, "GWAS_poly_output/K_method/k_method_LD_qtl_m.eff.csv")
```
...
write.csv(all_qtl, "GWAS_poly_output/PK_method/pk_method_all_qtl_bonferroni.csv")
```
...
write.csv(LD_qtl, "GWAS_poly_output/PK_method/pk_method_LD_qtl_bonferroni.csv")
```
...
write.csv(all_qtl, "GWAS_poly_output/PK_method/pk_method_all_qtl_m.eff.csv")
```
...
write.csv(LD_qtl, "GWAS_poly_output/PK_method/pk_method_LD_qtl_m.eff.csv")
```
...
write.csv(all_qtl, "GWAS_poly_output/QK_DAPC_method/qk_dapc_method_all_qtl_bonferroni.csv")
```
...
write.csv(LD_qtl, "GWAS_poly_output/QK_DAPC_method/qk_dapc_method_LD_qtl_bonferroni.csv")
```
...
write.csv(all_qtl, "GWAS_poly_output/QK_DAPC_method/qk_dapc_method_all_qtl_m.eff.csv")
```
...
write.csv(LD_qtl, "GWAS_poly_output/QK_DAPC_method/qk_dapc_method_LD_qtl_m.eff.csv")
```
...
write.csv(all_qtl, "GWAS_poly_output/QK_STRUCTURE_method/qk_structure_method_all_qtl_bonferroni.csv")
```
...
write.csv(LD_qtl, "GWAS_poly_output/QK_STRUCTURE_method/qk_structure_method_LD_qtl_bonferroni.csv")
```
...
write.csv(all_qtl, "GWAS_poly_output/QK_STRUCTURE_method/qk_structure_method_all_qtl_m.eff.csv")
```
...
write.csv(LD_qtl, "GWAS_poly_output/QK_STRUCTURE_method/qk_structure_method_LD_qtl_m.eff.csv")
```
