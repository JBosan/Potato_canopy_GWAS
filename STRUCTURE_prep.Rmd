...
A threshold of at least 0.25 looks sensible and retains enough SNPs. However,
to better ensure we only use the most informative possible SNPs for STRUCTURE 
will do a threshold of PIC > 0.4.
...
Based on this will create a list of SNPs that pass the missing data
and PIC thresholds to subset the data during STRUCTURE file prep.
