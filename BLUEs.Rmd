...
```
Finally we shall save the clean phenotype data for future plotting.

```{r}
write.csv(phenotype_17_18, file = "BLUEs_output/clean_phenotype_data_17_18.csv", row.names = F)

write.csv(phenotype, file = "BLUEs_output/clean_phenotype_data.csv", row.names = F)
```
