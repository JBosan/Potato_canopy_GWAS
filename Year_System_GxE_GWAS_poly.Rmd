...
# NOTE THESE SCRIPTS ARE ESSENTIALLY THE SAME AS ORIGINAL JUST USING DIFFERENT BLUES (I.E. GENE:YEAR AND GENE:SYSTEM AS RANDOM EFFECT)
...
```{r}
phenotype <- read.csv(file = "Year_System_GxE_BLUEs_output/Year_System_GxE_BLUEs_with_Q_matrices_and_PCs.csv")
glimpse(phenotype)
```
...
write.csv(phenotype_cultivar_filtered, 
          file = "Year_System_GxE_BLUEs_output/Year_System_GxE_BLUEs_with_Q_matrices_and_PCs_cultivar_filtered.csv",
          row.names = FALSE)
```
...
```{r}
pheno = "Year_System_GxE_BLUEs_output/Year_System_GxE_BLUEs_with_Q_matrices_and_PCs_cultivar_filtered.csv"
...
ggsave(filename = 
         "Year_System_GxE_GWAS_poly_output/K_method/QQ_k_method_yield_kg.pdf", 
...
ggsave(filename = 
         "Year_System_GxE_GWAS_poly_output/K_method/QQ_k_method_Max_Max_height_m.pdf", 
       plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(filename = 
         "Year_System_GxE_GWAS_poly_output/K_method/QQ_k_method_Max_Ave_height_m.pdf", 
       plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(filename = 
         "Year_System_GxE_GWAS_poly_output/K_method/QQ_k_method_Max_area_plant_m2.pdf", 
       plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(filename = 
         "Year_System_GxE_GWAS_poly_output/K_method/QQ_k_method_Max_volume_plant_m3.pdf", 
       plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/K_method/manhattan_k_method_additive_model.pdf", 
       plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/K_method/manhattan_k_method_1-dom_model.pdf", 
       plot = p1, device = pdf, width = 33, height = 20)
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/K_method/manhattan_k_method_1-dom_model_max_area_plant_m2_chr01.pdf", 
       plot = p1, device = pdf, width = 33, height = 20)
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/K_method/manhattan_k_method_1-dom_model_yield_kg_chr06.pdf", 
       plot = p1, device = pdf, width = 33, height = 20)
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/K_method/manhattan_k_method_2-dom_model.pdf", 
       plot = p1, device = pdf, width = 33, height = 20)
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/K_method/manhattan_k_method_2-dom_model_yield_kg_chr07.pdf", 
       plot = p1, device = pdf, width = 33, height = 20)
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/K_method/LD_plot_k_method.pdf", 
...
M.eff thresholds have extracted the data for both. Moreover, in both cases have
extracted QTL both with and without an LD window of 10 Mb (10e6) for comparison.
...
write.csv(all_qtl, "Year_System_GxE_GWAS_poly_output/K_method/k_method_all_qtl_bonferroni.csv")
```
...
write.csv(LD_qtl, "Year_System_GxE_GWAS_poly_output/K_method/k_method_LD_qtl_bonferroni.csv")
```
...
write.csv(all_qtl, "Year_System_GxE_GWAS_poly_output/K_method/k_method_all_qtl_m.eff.csv")
```
...
write.csv(LD_qtl, "Year_System_GxE_GWAS_poly_output/K_method/k_method_LD_qtl_m.eff.csv")
```
...
lambda_GC_k_method <- lambda_GC(
  ...
  traits=c("yield_kg",
           ...
           "Max_volume_plant_m3"),
  qqplot = TRUE,
  output_folder = "Year_System_GxE_GWAS_poly_output/K_method/lambda_GC/")
...
ggsave(filename = 
         "Year_System_GxE_GWAS_poly_output/PK_method/QQ_pk_method_yield_kg.pdf", 
       plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(filename = 
         "Year_System_GxE_GWAS_poly_output/PK_method/QQ_pk_method_Max_Max_height_m.pdf", 
       plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(filename = 
         "Year_System_GxE_GWAS_poly_output/PK_method/QQ_pk_method_Max_Ave_height_m.pdf", 
       plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(filename = 
         "Year_System_GxE_GWAS_poly_output/PK_method/QQ_pk_method_Max_area_plant_m2.pdf", 
       plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(filename = 
         "Year_System_GxE_GWAS_poly_output/PK_method/QQ_pk_method_Max_volume_plant_m3.pdf", 
       plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/PK_method/manhattan_pk_method_additive_model.pdf", 
  plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/PK_method/manhattan_pk_method_1-dom_model.pdf", 
  plot = p1, device = pdf, width = 33, height = 20)
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/PK_method/manhattan_pk_method_1-dom_model_max_area_plant_m2_chr01.pdf", 
  plot = p1, device = pdf, width = 33, height = 20)
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/PK_method/manhattan_pk_method_1-dom_model_yield_kg_chr06.pdf", 
  plot = p1, device = pdf, width = 33, height = 20)
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/PK_method/manhattan_pk_method_2-dom_model.pdf", 
  plot = p1, device = pdf, width = 33, height = 20)
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/PK_method/manhattan_pk_method_2-dom_model_yield_kg-chr07.pdf", 
  plot = p1, device = pdf, width = 33, height = 20)
```
...
As before, from the shape of the curve, a 10 Mb window seems appropriate. 
...
write.csv(all_qtl, "Year_System_GxE_GWAS_poly_output/PK_method/pk_method_all_qtl_bonferroni.csv")
```
...
write.csv(LD_qtl, "Year_System_GxE_GWAS_poly_output/PK_method/pk_method_LD_qtl_bonferroni.csv")
```
...
write.csv(all_qtl, "Year_System_GxE_GWAS_poly_output/PK_method/pk_method_all_qtl_m.eff.csv")
```
...
write.csv(LD_qtl, "Year_System_GxE_GWAS_poly_output/PK_method/pk_method_LD_qtl_m.eff.csv")
```
...
lambda_GC_pk_method <- lambda_GC(
  ...
  traits=c("yield_kg",
           ...
           "Max_volume_plant_m3"),
  qqplot = TRUE,
  output_folder = "Year_System_GxE_GWAS_poly_output/PK_method/lambda_GC/")
...
ggsave(filename = 
         "Year_System_GxE_GWAS_poly_output/QK_DAPC_method/QQ_qk_dapc_method_yield_kg.pdf", 
       plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(filename = 
         "Year_System_GxE_GWAS_poly_output/QK_DAPC_method/QQ_qk_dapc_method_Max_Max_height_m.pdf", 
       plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(filename = 
         "Year_System_GxE_GWAS_poly_output/QK_DAPC_method/QQ_qk_dapc_method_Max_Ave_height_m.pdf", 
       plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(filename = 
         "Year_System_GxE_GWAS_poly_output/QK_DAPC_method/QQ_qk_dapc_method_Max_area_plant_m2.pdf", 
       plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(filename = 
         "Year_System_GxE_GWAS_poly_output/QK_DAPC_method/QQ_qk_dapc_method_Max_volume_plant_m3.pdf", 
       plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/QK_DAPC_method/manhattan_qk_dapc_method_additive_model.pdf", 
  plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/QK_DAPC_method/manhattan_qk_dapc_method_1-dom_model.pdf", 
  plot = p1, device = pdf, width = 33, height = 20)
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/QK_DAPC_method/manhattan_qk_dapc_method_1-dom_model_max_area_plant_m2_chr01.pdf", 
  plot = p1, device = pdf, width = 33, height = 20)
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/QK_DAPC_method/manhattan_qk_dapc_method_1-dom_model_yield_kg_chr06.pdf", 
  plot = p1, device = pdf, width = 33, height = 20)
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/QK_DAPC_method/manhattan_qk_dapc_method_1-dom_model_yield_kg_chr09.pdf", 
  plot = p1, device = pdf, width = 33, height = 20)
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/QK_DAPC_method/manhattan_qk_dapc_method_2-dom_model.pdf", 
  plot = p1, device = pdf, width = 33, height = 20)
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/QK_DAPC_method/manhattan_qk_dapc_method_2-dom_model_yield_kg-chr07.pdf", 
  plot = p1, device = pdf, width = 33, height = 20)
```
...
write.csv(all_qtl, "Year_System_GxE_GWAS_poly_output/QK_DAPC_method/qk_dapc_method_all_qtl_bonferroni.csv")
```
...
write.csv(LD_qtl, "Year_System_GxE_GWAS_poly_output/QK_DAPC_method/qk_dapc_method_LD_qtl_bonferroni.csv")
```
...
write.csv(all_qtl, "Year_System_GxE_GWAS_poly_output/QK_DAPC_method/qk_dapc_method_all_qtl_m.eff.csv")
```
...
write.csv(LD_qtl, "Year_System_GxE_GWAS_poly_output/QK_DAPC_method/qk_dapc_method_LD_qtl_m.eff.csv")
```
...
lambda_GC_qk_dapc_method <- lambda_GC(
  ...
  traits=c("yield_kg",
           ...
           "Max_volume_plant_m3"),
  qqplot = TRUE,
  output_folder = "Year_System_GxE_GWAS_poly_output/QK_DAPC_method/lambda_GC/")
...
ggsave(filename = 
         "Year_System_GxE_GWAS_poly_output/QK_STRUCTURE_method/QQ_qk_structure_method_yield_kg.pdf", 
       plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(filename = 
         "Year_System_GxE_GWAS_poly_output/QK_STRUCTURE_method/QQ_qk_structure_method_Max_Max_height_m.pdf", 
       plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(filename = 
         "Year_System_GxE_GWAS_poly_output/QK_STRUCTURE_method/QQ_qk_structure_method_Max_Ave_height_m.pdf", 
       plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(filename = 
         "Year_System_GxE_GWAS_poly_output/QK_STRUCTURE_method/QQ_qk_structure_method_Max_area_plant_m2.pdf", 
       plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(filename = 
         "Year_System_GxE_GWAS_poly_output/QK_STRUCTURE_method/QQ_qk_structure_method_Max_volume_plant_m3.pdf", 
       plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/QK_STRUCTURE_method/manhattan_qk_structure_method_additive_model.pdf", 
  plot = p1, device = pdf, width = 33, height = 20) 
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/QK_STRUCTURE_method/manhattan_qk_structure_method_1-dom_model.pdf", 
  plot = p1, device = pdf, width = 33, height = 20)
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/QK_STRUCTURE_method/manhattan_qk_structure_method_1-dom_model_max_area_plant_m2_chr01.pdf", 
  plot = p1, device = pdf, width = 33, height = 20)
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/QK_STRUCTURE_method/manhattan_qk_structure_method_1-dom_model_yield_kg_chr06.pdf", 
  plot = p1, device = pdf, width = 33, height = 20)
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/QK_STRUCTURE_method/manhattan_qk_structure_method_2-dom_model.pdf", 
  plot = p1, device = pdf, width = 33, height = 20)
```
...
ggsave(
  filename = 
    "Year_System_GxE_GWAS_poly_output/QK_STRUCTURE_method/manhattan_qk_structure_method_2-dom_model_yield_kg-chr07.pdf", 
  plot = p1, device = pdf, width = 33, height = 20)
```
...
write.csv(all_qtl, "Year_System_GxE_GWAS_poly_output/QK_STRUCTURE_method/qk_structure_method_all_qtl_bonferroni.csv")
```
...
write.csv(LD_qtl, "Year_System_GxE_GWAS_poly_output/QK_STRUCTURE_method/qk_structure_method_LD_qtl_bonferroni.csv")
```
...
write.csv(all_qtl, "Year_System_GxE_GWAS_poly_output/QK_STRUCTURE_method/qk_structure_method_all_qtl_m.eff.csv")
```
...
write.csv(LD_qtl, "Year_System_GxE_GWAS_poly_output/QK_STRUCTURE_method/qk_structure_method_LD_qtl_m.eff.csv")
```
...
lambda_GC_qk_structure_method <- lambda_GC(
  ...
  traits=c("yield_kg",
           ...
           "Max_volume_plant_m3"),
  qqplot = TRUE,
  output_folder = "Year_System_GxE_GWAS_poly_output/QK_STRUCTURE_method/lambda_GC/")
...
```{r}
sharma_2018_height_snps <- read.csv(file = "Year_System_GxE_GWAS_poly_output/sharma_2018_height_snps.csv")
...
writexl::write_xlsx(height_snp_comparison, 
                    path = "Year_System_GxE_GWAS_poly_output/height_comparison_snps.xlsx")
```
